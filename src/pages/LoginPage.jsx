...
export function LoginPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Log In – Sofia Varelli Fan Site</title>
        <meta name="description" content="Log in to your Sofia Varelli account to access exclusive photos, videos, and messages." />
        <link rel="canonical" href="https://sofiavarelli.com/login" />
      </Helmet>
