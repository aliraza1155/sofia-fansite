...
export function SignupPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up – Join Sofia Varelli's Exclusive Fan Club</title>
        <meta name="description" content="Create an account to unlock exclusive photos, videos, and direct messages from Sofia Varelli. Join thousands of fans today." />
        <link rel="canonical" href="https://sofiavarelli.com/signup" />
      </Helmet>
