...
export function MessagesPage() {
  ...
  return (
    <>
      ...
      <div>
        {/* Page Heading (visible only when logged in) */}
        <h1 style={{ fontSize: isMobile ? 24 : 32, color: "#fff", marginBottom: 20, fontFamily: "'Playfair Display', serif" }}>
          Direct Messages
        </h1>
        ...
        <div style={{ marginTop: 40, background: "#1a1a1a", borderRadius: 16, padding: "20px", display: "flex", gap: 16, alignItems: "center" }}>
          ...
          <div>
            ...
            <div style={{ color: "#aaa", fontSize: 13, marginTop: 4 }}>I personally read and reply to every message. Tips unlock exclusive content.</div>
          </div>
        </div>
